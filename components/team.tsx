                          ...
                          <div className="w-full md:w-1/2 p-7">
                            <div className="flex flex-wrap -m-3.5">
                              <div className="w-auto p-3.5">
                                <img className="w-32 h-32 rounded-full object-cover" src="/team/lisa_reiss.png" alt=""/>
                              </div>
                              <div className="flex-1 p-3.5">
                                ...
                                <h3 className="font-heading font-bold text-lg text-[#628474]">Lisa Reiss, <span className="font-light">Marketing & Sales</span></h3>
                              </div>
                            </div>
                          </div>
                          <div className="w-full md:w-1/2 p-7">
                            <div className="flex flex-wrap -m-3.5">
                              <div className="p-3.5">
                                <img className="w-32 h-32 rounded-full object-cover" src="/team/maximilian_geyer.png" alt=""/>
                              </div>
                              <div className="flex-1 p-3.5">
                                ...
                                <h3 className="font-heading font-bold text-lg text-[#628474]">Maximilian Geyer, <span className="font-light">Operations & Business Development</span></h3>
                              </div>
                            </div>
                          </div>
                        </div>
                          ...
                          <div className="w-full md:w-1/2 p-7">
                            <div className="flex flex-wrap -m-3.5">
                              <div className="flex-1 p-3.5 order-1">
                                <p className="mb-6 text-lg text-gray-700">Lorem ipsum dolor sit amet, consec tetur adipis cing elit. Eleifend id vulpu tate amet nunc. Elit sagittis sollici tudin cursus aliquam quis dui. Ut curabitur morbi nunc sit leo tellus neque dolor. Amet sem egestas.</p>
                                <h3 className="font-heading font-bold text-lg text-[#628474]">Kyrillus Mehanni, <span className="font-light">Web Development</span></h3>

                              </div>
                              <div className="w-auto p-3.5 md:order-1">
                                <img className="w-32 h-32 rounded-full object-cover" src="/team/kyrillus_mehanni.png" alt=""/>
                              </div>
                            </div>
                          </div>
                          <div className="w-full md:w-1/2 p-7">
                            <div className="flex flex-wrap -m-3.5">
                              <div className="flex-1 p-3.5 order-1">
                                <p className="mb-6 text-lg text-gray-700">Lorem ipsum dolor sit amet, consec tetur adipis cing elit. Eleifend id vulpu tate amet nunc. Elit sagittis sollici tudin cursus aliquam quis dui. Ut curabitur morbi nunc sit leo tellus neque dolor. Amet sem egestas.</p>
                                <h3 className="font-heading font-bold text-lg text-[#628474]">Sami Elyas, <span className="font-light">Product Development</span></h3>
                              </div>
                              <div className="w-auto p-3.5 md:order-1">
                                <img className="w-32 h-32 rounded-full object-cover" src="/team/sami_elyas.png" alt=""/>
                              </div>
                            </div>
                          </div>
                        </div>
